...
const webpackConfig          = merge(baseWebpackConfig, {
  ...
  output : {
    ...
    filename     : utils.assetsPath('js/[name].js?v='+timeSpan),
    chunkFilename: utils.assetsPath('js/[id].js?v='+timeSpan)
  },
  plugins: [
    ...
    new AliyunossWebpackPlugin({
      ...
      generateObjectPath: function (filename, file) {
        return ossConf.dist+'/'+ file.replace(/dist\//, '')
      }
    }),
    ...
    new ExtractTextPlugin({
      filename: utils.assetsPath('css/[name].css?v='+timeSpan),
