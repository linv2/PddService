...
{
    [PddRequestMethod("pdd.cloudprint.cmdprint.render")]
    public partial class RenderCloudprintCmdprintRequestModel : PddRequestModel<RenderCloudprintCmdprintResponseModel>
    {
        /// <summary>
        /// request
        /// </summary>
